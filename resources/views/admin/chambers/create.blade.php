{{-- resources/views/admin/chambers/create.blade.php --}}
@extends('layouts.admin')

@section('page-title', 'Add Chamber')

@section('content')
    <div class="max-w-4xl">
        <div class="bg-white rounded-lg shadow p-8">
            <form action="{{ route('admin.chambers.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div id="visiting-hours-container" class="space-y-3">
                        <div class="visiting-hour-row flex gap-3">
                            <input type="text" name="visiting_hours[0][day]" placeholder="Day" required
                                   class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500">
                            <input type="text" name="visiting_hours[0][time]" placeholder="Time" required
                                   class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500">
                ...
                <div class="flex gap-3">
                    <button type="submit" class="bg-cyan-700 text-white px-8 py-3 rounded-lg font-medium hover:bg-cyan-800 transition">
                        <i class="fas fa-save mr-2"></i>Add Chamber
                    </button>
